...
export const toPaymentListItem = (payment) => ({
  ...
  printCount: payment.printCount ?? 0,
  lastPrintedAt: payment.lastPrintedAt ?? null,
...
export const toPaymentResponse = (
  ...
  transactionCode: payment.transactionCode ?? null,
  paymentStatus: payment.paymentStatus,
  initiatedBy: mapUserReference(payment.initiatedBy),
  confirmedBy: mapUserReference(payment.confirmedBy),
  printCount: payment.printCount ?? 0,
  lastPrintedAt: payment.lastPrintedAt ?? null,
  lastPrintedBy: mapUserReference(payment.lastPrintedBy),
  paidAt: getPaymentCompletedAt(payment),
