...
import { getRefreshTokenFromRequest, setAuthCookies, clearAuthCookies } from "../../shared/helpers/token.helper.js";
...
export const refreshToken = asyncHandler(async (req, res) => {
  ...
  return successResponse(res, toAuthResponseBody(data), "Refresh token successfully");
});
