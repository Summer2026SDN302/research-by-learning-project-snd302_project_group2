...
const DataTable = ({
  ...
  return (
    <div className="relative w-full overflow-x-auto rounded-xl border border-outline-variant bg-surface-container-lowest shadow-soft">
          ...
          {!isLoading && sortedRows.length === 0 ? (
            ...
            sortedRows.map((row, idx) => (
              <tr
                ...
                className={`border-b border-outline-variant/50 transition-colors duration-100 ${
                  onRowClick
