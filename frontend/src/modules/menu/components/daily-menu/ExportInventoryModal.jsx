 ...
 *   open         {boolean}
 *   onClose      {fn}
 *   onExport     {fn}       - async (type) => void
 */
const reportOptions = [
  { value: "stock", label: "Báo cáo tồn kho chung", icon: "inventory_2" },
  { value: "low-stock", label: "Báo cáo sắp hết hàng (<= 3 phần)", icon: "warning" },
  { value: "movement", label: "Lịch sử xuất nhập (Chuẩn bị / Đã bán)", icon: "sync_alt" },
];

const ExportInventoryModal = ({ open, onClose, onExport }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
      ...
      <div className="relative w-full max-w-md transform rounded-2xl bg-surface-container-lowest p-6 text-left align-middle shadow-xl transition-all">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            <h3 className="font-title-lg text-on-surface">Xuất báo cáo kho</h3>
            <p className="mt-1 font-body-sm text-outline">
              Tải xuống file Excel báo cáo tồn kho
            </p>
          </div>
        </div>
