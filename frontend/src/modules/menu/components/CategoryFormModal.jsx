...
const CategoryFormModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-surface-container-lowest w-full max-w-2xl max-h-[80vh] rounded-3xl shadow-lg border border-outline-variant overflow-hidden flex flex-col">
